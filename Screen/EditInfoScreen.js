      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View style={{ flex: 1, padding: 20 }}>
          ...
          <View style={{ alignItems: 'center', marginBottom: 30, padding:15, backgroundColor: '#ffffff', borderRadius:15 }}>
            ...
            <TextInput placeholder={strings.name} value={name} onChangeText={setName} style={{ borderWidth: 1, borderColor: '#CCCCCC', borderRadius: 5, paddingHorizontal: 10, marginBottom: 8, width: windowWidth - 70 }} />
            <TextInput placeholder={strings.phone_number} value={phoneNumber} onChangeText={setPhoneNumber} style={{ borderWidth: 1, borderColor: '#CCCCCC', borderRadius: 5, paddingHorizontal: 10, marginBottom: 8, width: windowWidth - 70 }} />
            <TextInput placeholder={strings.height} value={height} onChangeText={setHeight} style={{ borderWidth: 1, borderColor: '#CCCCCC', borderRadius: 5, paddingHorizontal: 10, marginBottom: 8, width: windowWidth - 70 }} />
            <TextInput placeholder={strings.weight} value={weight} onChangeText={setWeight} style={{ borderWidth: 1, borderColor: '#CCCCCC', borderRadius: 5, paddingHorizontal: 10, marginBottom: 8, width: windowWidth - 70 }} />
            <TextInput placeholder={strings.activity_level} value={activityLevel} onChangeText={setActivityLevel} style={{ borderWidth: 1, borderColor: '#CCCCCC', borderRadius: 5, paddingHorizontal: 10, marginBottom: 8, width: windowWidth - 70 }} />
            <TextInput placeholder={strings.goal} value={goal} onChangeText={setGoal} style={{ borderWidth: 1, borderColor: '#CCCCCC', borderRadius: 5, paddingHorizontal: 10, marginBottom: 8, width: windowWidth - 70 }} />
